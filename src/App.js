...
*/}
        ...
        <div className="container flex items-center justify-center h-full max-w-6xl px-8 mx-auto sm:justify-between xl:px-0">
          ...
          >
            ...
            <span className="ml-3 text-xl text-gray-800">
              Techbridge<span className="text-pink-500">.</span>
            </span>
          </a>
          <nav
            id="nav"
        ...
        <div className="container flex flex-col items-center justify-between h-full max-w-6xl px-8 mx-auto -mt-32 lg:flex-row xl:px-0">
          <div className="z-30 flex flex-col items-center w-full max-w-xl pt-48 text-center lg:items-start lg:w-1/2 lg:pt-20 xl:pt-40 lg:text-left">
            ...
            <p className="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">
              ...
              ideas into market-ready solutions. Our expert consultancy in
              project management, product design, and quality assurance, coupled
              with top-tier development in back-end, front-end, and full-stack
              technologies, ensures your project’s success and scalability.
              Ready to elevate your business with robust and efficient digital
              solutions?
            </p>
      ...
      <div
        id="features"
        className="relative w-full px-8 py-10 border-t border-gray-200  lg:py-24 xl:py-40 xl:px-0"
      >
            ...
            <div className="w-full max-w-md p-4 mx-auto mb-16 lg:mb-0 lg:w-1/3">
              <div className="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                ...
                <p className="relative mt-2 text-base text-center text-gray-600">
                  ...
                  assurance, thereby enhancing business innovation and success.
                </p>
                <a
                  href="#_"
                  className="relative flex mt-2 text-sm font-medium text-indigo-500 underline"
      ...
      {/* <div className="flex flex-col items-center justify-center space-x-4">
        <div className="text-center text-xl font-semibold">
          <Counter target={15} /> Engineers
        </div>
        <div className="text-center text-xl font-semibold">
          <Counter target={4} /> Clients
        </div>
        <div className="text-center text-xl font-semibold">
          <Counter target={4} /> Designers
        </div>
        <div className="text-center text-xl font-semibold">
          <Counter target={4} /> Ongoing Projects
        </div>
      </div> */}
      ...
      <div className="flex justify-center space-x-8 mb-5">
        <div className="flex flex-col items-center">
          <Counter target={15} />
          <span className="text-3xl mt-2">Engineers</span>
        </div>
        <div className="flex flex-col items-center">
          <Counter target={4} />
          <span className="text-3xl mt-2">Clients</span>
        </div>
        <div className="flex flex-col items-center">
          <Counter target={4} />
          <span className="text-3xl mt-2">Designers</span>
        </div>
        <div className="flex flex-col items-center">
          <Counter target={4} />
          <span className="text-3xl mt-2">Ongoing Projects</span>
        </div>
      </div>
                  ...
                  <div className="flex flex-col pr-8">
                    <div className="relative pl-12">
                      ...
                      <p className="mt-2 text-base text-gray-600">
                        TechBridge Solutions transformed our startup journey.
                        Their expert consultancy in project management and
                        product design accelerated our growth and innovation."
                      </p>
                    </div>
                ...
                <blockquote className="flex flex-col-reverse items-center justify-between w-full col-span-1 p-6 mt-16 mb-16 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease xl:mb-0">
                  <div className="flex flex-col pr-10">
                    <div className="relative pl-12">
                      ...
                      <p className="mt-2 text-base text-gray-600">
                        "The development services from TechBridge, especially in
                        back-end and full-stack, were pivotal in scaling our
                        startup's tech capabilities."
                      </p>
                    </div>
                    {/* <h3 className="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">
                      Kenny Jones{" "}
                ...
                <blockquote className="flex flex-col-reverse items-center justify-between w-full col-span-1 p-6 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease">
                  <div className="flex flex-col pr-10">
                    <div className="relative pl-12">
                      ...
                      <p className="mt-2 text-base text-gray-600">
                        "TechBridge's approach to quality assurance and database
                        architecture has significantly improved our product's
                ...
                <blockquote className="flex flex-col-reverse items-center justify-between w-full col-span-1 p-6 mt-16 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease">
                  <div className="flex flex-col pr-10">
                    <div className="relative pl-12">
                      ...
                      <p className="mt-2 text-base text-gray-600">
                        "Their user-centric solutions and strategic guidance
                        have been instrumental in the success and
                        market-readiness of our startup's digital products."
                      </p>
                    </div>
                    {/* <h3 className="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">
                      Molly Sanchez{" "}
